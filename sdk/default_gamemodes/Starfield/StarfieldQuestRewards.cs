...
// Grants the player character experience as quests advance, the way Starfield pays
// XP for mission progress. It subscribes to the engine's QuestStageChanged, which
...
// farm XP. Feeds CharacterProgress, so quest progress drives leveling and the
// skill points that unlock skills, tying the questing layer to the gameplay loop.
public sealed class StarfieldQuestRewards : GameBehaviour
{
